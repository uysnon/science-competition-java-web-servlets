...
import ru.rsreu.sciencecompetition.web.commands.admin.*;
import ru.rsreu.sciencecompetition.web.commands.expert.MakeDecisionCommand;
import ru.rsreu.sciencecompetition.web.commands.expert.ShowWorkToCheckByDecisionCommand;
import ru.rsreu.sciencecompetition.web.commands.expert.ShowWorkToCheckByParticipationCommand;
import ru.rsreu.sciencecompetition.web.commands.expert.ShowWorksToCheckCommand;
import ru.rsreu.sciencecompetition.web.commands.guest.*;
import ru.rsreu.sciencecompetition.web.commands.loggedin.*;
import ru.rsreu.sciencecompetition.web.commands.participant.*;
